    ...
    items: [
      {
        ...
        answer: `IT業界に興味のある方やプログラミングやデザインに興味のある方にオススメしております。ITのビジネスを生で見ることができるので、ITを用いたビジネスにご興味のある方にもオススメです。`,
      },
      {
      ...
      },
      {
        ...
        answer: `参加しただけでプログラミングができるようになるものではございません。自主学習と併用してご活用いただくことをオススメしています。「一人だとモチベーションが維持できない」「詰まったときに答えが見つからない」「実際にコードを書こうとすると分からなくなる」といったプログラミング学習における課題を解決できるための仕組みを用意しております。`,
      },
      {
    ...
    items: [
      {
        ...
        answer: `クレジットカード、Apple Pay、Google Payをご利用いただけます。`,
      },
      {
