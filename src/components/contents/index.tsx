...
const ITEMS = [
  {
    ...
    title: "プロダクト開発",
    body:
      "私含め現役エンジニアが新規事業のプロジェクトをたてます。プロジェクトのコードはみんなが読めるようにGitHubを使用し、適宜コードの解説も行います。コードを書ける方には実際に開発に参加していただき、チーム開発の実戦を経験していただきます。",
  },
  {
  ...
  },
  {
    ...
    title: "ブログ & アウトプット",
    body:
      "Qastにはブログ機能も備わっており、誰でもブログを書くことができます。外部だと心無い指摘が少し怖いですが、当サロンはみんなが優しく教えてくれますので学びは積極的にアウトプットしていきましょう。また私含め現役エンジニアもブログを執筆します。",
  },
  {
  ...
  },
  {
    ...
    title: "楽しめるコミュニティ",
    body:
      "ただ学ぶだけではなく楽しめるサロンにします。Workplaceというサービスを用いて頻繁に交流の場を設けます。一緒に勉強するもくもく会、質疑応答をライブ配信、趣味のチャットグループ、オンライン飲み会、オフライン交流会などを予定しています。",
