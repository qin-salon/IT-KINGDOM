...
const ITEMS = [
  ...
  },
  {
    ...
    title: "みんなに質問",
    body:
      "運営が独自でつくったプラットフォームがあり、そこには質問機能があります。質問をしていただくと運営やサロン内のエンジニアが回答します。質問の際は回答者が答えやすくなるように詳細な情報を添えてください。また皆さんも回答側になれますので、困っている仲間がいたら助けましょう。",
  },
  {
    ...
    title: "メモ & アウトプット",
    body:
      "IT KINGDOMのプラットフォームにはメモ機能も備わっています。外部だと心無い指摘が怖いかもしれませんが、当サロンではみんなが優しく教えてくれますので気軽にアウトプットできます。運営のエンジニアも適宜メモを残していく予定です。",
  },
  {
    src: "/img/contents/news.png",
    title: "限定コンテンツ",
    body:
      "最低でも月に6本は動画が配信されます。YouTubeより数ヶ月早く講座が見れたり、サロンでしか見られない講座もございます。月に一度、運営のエンジニアが旬な情報をまとめてお届けするライブ配信も人気があります。またSlackでは毎日活発にニュースのシェアが行われています。",
  },
  {
    ...
    title: "楽しめるコミュニティ",
    body:
      "ただ学ぶだけではなく楽しめるサロンを目指して、頻繁にビデオチャットやSlackを用いて交流の場を設けています。例えば毎日朝活が行われていたり、一緒に勉強するもくもく会、学びの成果を発表するLT、オンライン交流会、ライブ配信で質疑応答・雑談など、様々なイベントが実施されています。",
