...
const STEPS = [
  {
    title: "入国手続きを行う",
    body:
      "サロンに参加するにはページ上部または下部にある「入国手続きを行う」ボタンから行えます。GitHubまたはGoogleのアカウント連携で登録が可能です。プログラミングを学びたい方にはGitHub連携をオススメしています。GitHub連携をした方へは、お支払い完了後にGitHubのチームへの招待メールが届きます。",
  },
  {
    title: "プロフィールを登録する",
    body:
